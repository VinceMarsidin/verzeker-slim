...
//
// LET OP: deze 4 tabellen waren per ongeluk verdwenen bij het oplossen van
// een merge-conflict — zonder deze tabellen kan Better Auth geen gebruikers
// aanmaken/opzoeken en werkt inloggen niet.
// ---------------------------------------------------------------------------
