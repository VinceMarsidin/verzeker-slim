...
export const companies: Company[] = [
  // Suriname 
  {
    ...
    name: 'Assuria',
    logoInitial: 'A',
    logoUrl: '/companies/assuria-suriname/logo.png',
    homepageImage: '/companies/assuria-suriname/homepage.jpg',
    region: 'suriname',
  ...
  },
  {
    ...
    name: 'Parsasco',
    logoInitial: 'P',
    logoUrl: '/companies/parsasco/logo.png',
    homepageImage: '/companies/parsasco/homepage.jpg',
    region: 'suriname',
  ...
  // Aruba 
  {
    ...
    name: 'Nagico',
    logoInitial: 'N',
    logoUrl: '/companies/nagico-aruba/logo.png',
...

  {
    ...
    logoInitial: 'P',
    logoUrl: '/companies/pan-american-life-aruba/logo.png',
    homepageImage: '/companies/pan-american-life-aruba/homepage.jpg',
    region: 'aruba',
 ...
 
  {
    ...
    name: 'Sagicor Life',
    logoInitial: 'S',
    logoUrl: '/companies/sagicor-life-aruba/logo.png',
    homepageImage: '/companies/sagicor-life-aruba/homepage.jpg',
    region: 'aruba',
  ...
  // Curaçao 
  {
    ...
    logoInitial: 'E',
    logoUrl: '/companies/ennia-curacao/logo.png',
    homepageImage: '/companies/ennia-curacao/homepage.jpg',
    region: 'curacao',
...

  {
    ...
    name: 'Bsure',
    logoInitial: 'B',
    logoUrl: '/companies/bsure-curacao/logo.png',
    region: 'curacao',
  ...
  },
  {
    ...
    name: 'Nagico',
    logoInitial: 'N',
    logoUrl: '/companies/nagico-curacao/logo.png',
    region: 'curacao',
    website: 'https://www.nagico.com',
  ...
  // Bonaire 
  {
    ...
    name: 'Ennia',
    logoInitial: 'E',
    logoUrl: '/companies/ennia-bonaire/logo.png',
    homepageImage: '/companies/ennia-bonaire/homepage.jpg',
    region: 'bonaire',
  ...
  },
   {
    ...
    name: 'Bsure',
    logoInitial: 'B',
    logoUrl: '/companies/bsure-bonaire/logo.png',
    homepageImage: '/companies/bsure-bonaire/homepage.jpg',
    region: 'bonaire',
  ...
  },
  {
    ...
    logoInitial: 'B',
    logoUrl: '/companies/boogaard-insurance/logo.png',
    homepageImage: '/companies/boogaard-insurance/homepage.jpg',
    region: 'bonaire',
  ...
  // Jamaica
  {
    ...
    name: 'Sagicor',
    logoInitial: 'S',
    logoUrl: '/companies/sagicor-jamaica/logo.png',
    region: 'jamaica',
...

  {
    ...
    logoInitial: 'A',
    logoUrl: '/companies/advantage-general-jamaica/logo.png',
    homepageImage: '/companies/advantage-general-jamaica/homepage.jpg',
    region: 'jamaica',
  ...
  },
  {
    ...
    logoInitial: 'B',
    logoUrl: '/companies/british-caribbean-insurance/logo.png',
    homepageImage: '/companies/british-caribbean-insurance/homepage.jpg',
    region: 'jamaica',
 ...
 
  {
    ...
    logoInitial: 'S',
    logoUrl: '/companies/sagicor-trinidad/logo.png',
    region: 'trinidad',
  ...
  },
  {
    ...
    name: 'Nagico',
    logoInitial: 'N',
    logoUrl: '/companies/nagico-trinidad/logo.png',
    region: 'trinidad',
 ...
 
  {
    ...
    logoInitial: 'M',
    logoUrl: '/companies/maritime-financial-group/logo.png',
    homepageImage: '/companies/maritime-financial-group/homepage.jpg',
    region: 'trinidad',
  ...
  // Guyana 
  {
    ...
    name: 'Assuria Guyana',
    logoInitial: 'A',
    logoUrl: '/companies/assuria-guyana/logo.png',
    region: 'guyana',
  ...
  },
  {
    ...
    logoInitial: 'C',
    logoUrl: '/companies/cg-united-insurance/logo.png',
    homepageImage: '/companies/cg-united-insurance/homepage.jpg',
    region: 'guyana',
  ...
  },
  {
    ...
    logoInitial: 'H',
    logoUrl: '/companies/hand-in-hand-guyana/logo.png',
    homepageImage: '/companies/hand-in-hand-guyana/homepage.jpg',
    region: 'guyana',
  ...
  // French Guiana 
  {
    ...
    logoInitial: 'G',
    logoUrl: '/companies/groupama-antilles-guyane/logo.png',
    homepageImage: '/companies/groupama-antilles-guyane/homepage.jpg',
  ...
  },
  {
    ...
    name: 'Allianz Guyane',
    logoInitial: 'A',
    logoUrl: '/companies/allianz-guyane/logo.png',
    homepageImage: '/companies/allianz-guyane/homepage.jpg',
    region: 'french-guiana',
  ...
  },
  {
    ...
    name: 'GMF Assurances',
    logoInitial: 'G',
    logoUrl: '/companies/gmf-assurances/logo.png',
    homepageImage: '/companies/gmf-assurances/homepage.jpg',
    region: 'french-guiana',
